...
import { BAD_REQUEST, CONFLICT, INTERNAL_SERVER_ERROR, OK } from "http-status-codes";
...
describe("UserRouter", () => {
  ...
  describe(`"GET:${getUsersPath}"`, () => {
    ...
    it(`should return a JSON object containing an error message and a status code of
            "${INTERNAL_SERVER_ERROR}" if the request was unsuccessful.`, (done) => {
      // Setup Dummy Data
  ...
  describe(`"DELETE:${deleteUserPath}"`, () => {
    ...
    it(`should return a JSON object with an error message and a status code of "${INTERNAL_SERVER_ERROR}"
            if the request was unsuccessful.`, (done) => {
      // Setup Dummy Response
